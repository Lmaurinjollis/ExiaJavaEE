...
public class JPQLTest {
    ...
    public void checkRequestWithStringParameter(){
        String jpql = "SELECT b FROM Book b WHERE b.title like :bookTitle"; //remplacez par votre requête 
        String param="%n%"; //remplacez par la valeur de type %votreChaine% (votre motif de recherche encadré par %)
        String paramName = "bookTitle";//remplacez par le nom du paramètre tel qu'il est défini dans votre requête JPQL
